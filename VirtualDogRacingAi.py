...
ascii_art = text2art("VirtualDogRacingAi")

print("============================================================")
print("VirtualDogRacingAi")
...
print(ascii_art)
print("Virtual Dog Racing prediction artificial intelligence")
print("============================================================")
...
# Filter rows with less than 6 or more than 6 numbers
data = data[(np.count_nonzero(data, axis=1) >= 6) & (np.count_nonzero(data, axis=1) <= 6)]
